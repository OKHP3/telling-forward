...
> **Numbering note (2026-08-19):** `docs/adr/` currently holds three files numbered 0007, one at 0008, and two different files both titled "ADR-0009" internally (`0009-capsule-provenance-and-term-ledger-field-schemas.md` and `0009-provenance-as-platform-differentiator-from-first-mover-claim.md`) — the product of several Cowork sessions scavenging MPS/BAC-sourced threads concurrently on 2026-08-19 without visibility into each other's writes. This ADR supersedes and extends the content of `0009-capsule-provenance-and-term-ledger-field-schemas.md` (same author session) and takes the next actually-free number, 0010, rather than deepen the 0009 collision. `0009-capsule-provenance-and-term-ledger-field-schemas.md` should be deleted once this ADR is confirmed to carry its content forward (it does — see items 1 and 2 below). The 0007/0008/0009 collisions from *other* sessions are not resolved by this ADR and remain the owner's to consolidate.
