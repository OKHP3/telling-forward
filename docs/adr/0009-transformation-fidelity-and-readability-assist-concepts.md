...
**Update, post-commit:** this ADR is now committed at `docs/adr/0009-transformation-fidelity-and-readability-assist-concepts.md`. The files that briefly collided at 0010 are now uniquely numbered 0010 and 0011. The final 0007 collision was resolved by retaining `0007-reader-accessibility-register-and-clarity-pass-from-bac-thread.md` and renumbering the separate scene-purpose ADR to `0012-scene-purpose-framing-from-synopsis-discipline.md`. This ADR's own number is stable.
