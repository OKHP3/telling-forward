...
| Basic reader edition | Render selected scenes as readable full text, with title, attribution, canon state, and content notes. | A deployable static or service-hosted edition. | **Implemented in checkout, 2026-08-22; Author App static deployment verified on GitHub Pages, 2026-08-24; API-backed reading remains unverified** |
