...
- [Workspace declaration builds](workspace-declaration-builds.md) — artifact typechecks can read stale workspace declaration output after schema edits; emit declarations before checking dependents.
