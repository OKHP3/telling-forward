...
This Mistral Vibe package contains three platform-specific extraction evals with
...
The Mistral Vibe parsing rules remain covered by this package's platform eval
