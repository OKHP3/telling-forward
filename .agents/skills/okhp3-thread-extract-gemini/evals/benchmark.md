...
This Google Gemini package contains three platform-specific extraction evals with
...
The Google Gemini parsing rules remain covered by this package's platform eval
